...
- **Ottimizzazione del Layout Split-Screen:** Ridotta la larghezza della colonna sinistra (Postbox) da 350px a 280px e impostata la larghezza dell'anteprima allegato a un valore fisso di 420px. Questo lascia tutto lo spazio fluido rimanente (~700px su schermi standard) a `SpeseForm`, garantendo che la griglia di ripartizione spese e i dettagli abbiano ampio spazio e non risultino schiacciati.
